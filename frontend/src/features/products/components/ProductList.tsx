...
export const ProductList: FC<Props> = ({ productList }) => (
  <li className="border-0 border-b border-solid border-slate-200 py-2">
    <Text underline className="sticky top-0 bg-white">
      {productList && format(new Date(productList?.date), "yyyy年MM月dd日")}
    </Text>
